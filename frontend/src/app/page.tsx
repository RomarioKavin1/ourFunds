...
function page() {
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div
        className="circlePosition w-[520px] h-[400px]
     ...
     blur-[100px]"
      ...
      <div className="flex-grow mt-48 flex flex-col items-center justify-center">
        ...
        <p className="font-encode-light m-10">
        ...
        <button
          className=" bg-[white]/[0.12] p-2 rounded-lg flex items-center mt-10 
      ...
      {/* Bottom glow effect */}
      <div className="absolute bottom-56 left-1/2 transform -z-10 -translate-x-1/2 translate-y-[40%] w-[700px] h-[420px] bg-first rounded-[100%] blur-[80px]"></div>
    </div>
  );
}
